        ...
        <div id="page-2">
            <div id="sobre-mim-box">
                ...
                <div id="desc-sobre-mim-box"> 
                    <p>Meu nome é Pedro Henrique Sencio, tenho 20 anos, natural de Ourinhos-SP, atualmente cursando o 6º semestre do curso de Análise e Desenvolvimento de Sistemas na FATEC Ourinhos. Tenho grande interesse pelas áreas de tecnologia, desenvolvimento web e soluções digitais, e hoje atuo como estagiário na área de e-commerce da empresa Auto Peças São Jorge.</p>  </div>
